...
public class BoardManager : MonoBehaviour
{
    ...
    Vector3 RandomPosition() //retourne une position al�atoire
    {
    ...
    void LayoutObjectAtRandom(GameObject[] tileArray, int min, int max, int index) //choisi al�atoirement les objets a placer 
    {
